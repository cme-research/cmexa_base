...
#include "cmexa_base/diffbot_system.hpp"
...
CmexaDiffBotSystemHardware::CmexaDiffBotSystemHardware()
{
...
void CmexaDiffBotSystemHardware::feedbackRearLeftCallback(const cmeresearch_msgs::msg::TinkerStepperFeedback::SharedPtr msg)
{
  //RCLCPP_INFO(node_->get_logger(), "FeedbackRearLeftCallback received: %f", msg->current_velocity);
}

hardware_interface::CallbackReturn CmexaDiffBotSystemHardware::on_init(
...
hardware_interface::CallbackReturn CmexaDiffBotSystemHardware::on_configure(
...
hardware_interface::CallbackReturn CmexaDiffBotSystemHardware::on_activate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
  // BEGIN: This part here is for exemplary purposes - Please do not copy to your production code
...
hardware_interface::CallbackReturn CmexaDiffBotSystemHardware::on_deactivate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
  // BEGIN: This part here is for exemplary purposes - Please do not copy to your production code
...
hardware_interface::return_type CmexaDiffBotSystemHardware::read(
...
hardware_interface::return_type cmexa_base ::CmexaDiffBotSystemHardware::write(
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
  ...
  for (const auto & [name, descr] : joint_command_interfaces_)
  {
    ...
    if (name == "front_right_wheel_joint/velocity")
    {
...
PLUGINLIB_EXPORT_CLASS(
  cmexa_base::CmexaDiffBotSystemHardware, hardware_interface::SystemInterface)
