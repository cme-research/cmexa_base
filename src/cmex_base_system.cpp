...
#include "cmex_base/cmex_base_system.hpp"
...
CmexBotSystemHardware::CmexBotSystemHardware()
{
  node_ = std::make_shared<rclcpp::Node>("cmex_base");
  ...
  feedback_front_left_sub_ = node_->create_subscription<cmeresearch_msgs::msg::TinkerStepperFeedback>("~/front_left/feedback", 10, std::bind(&CmexBotSystemHardware::feedbackFrontLeftCallback, this, std::placeholders::_1));
  feedback_front_right_sub_ = node_->create_subscription<cmeresearch_msgs::msg::TinkerStepperFeedback>("~/front_right/feedback", 10, std::bind(&CmexBotSystemHardware::feedbackFrontRightCallback, this, std::placeholders::_1));
  feedback_rear_left_sub_ = node_->create_subscription<cmeresearch_msgs::msg::TinkerStepperFeedback>("~/rear_left/feedback", 10, std::bind(&CmexBotSystemHardware::feedbackRearLeftCallback, this, std::placeholders::_1));
  feedback_rear_right_sub_ = node_->create_subscription<cmeresearch_msgs::msg::TinkerStepperFeedback>("~/rear_right/feedback", 10, std::bind(&CmexBotSystemHardware::feedbackRearRightCallback, this, std::placeholders::_1));
}

void CmexBotSystemHardware::feedbackFrontLeftCallback(const cmeresearch_msgs::msg::TinkerStepperFeedback::SharedPtr msg)
{
    //RCLCPP_INFO(node_->get_logger(), "FeedbackFrontLeftCallback received: %f", msg->current_velocity);
}

void CmexBotSystemHardware::feedbackFrontRightCallback(const cmeresearch_msgs::msg::TinkerStepperFeedback::SharedPtr msg)
{
  //RCLCPP_INFO(node_->get_logger(), "FeedbackFrontRightCallback received: %f", msg->current_velocity);
}

void CmexBotSystemHardware::feedbackRearLeftCallback(const cmeresearch_msgs::msg::TinkerStepperFeedback::SharedPtr msg)
{
  //RCLCPP_INFO(node_->get_logger(), "FeedbackRearLeftCallback received: %f", msg->current_velocity);
}

void CmexBotSystemHardware::feedbackRearRightCallback(const cmeresearch_msgs::msg::TinkerStepperFeedback::SharedPtr msg)
{
   //RCLCPP_INFO(node_->get_logger(), "FeedbackRearRightCallback received: %f", msg->current_velocity);
}

hardware_interface::CallbackReturn CmexBotSystemHardware::on_init(
...
hardware_interface::CallbackReturn CmexBotSystemHardware::on_configure(
...
hardware_interface::CallbackReturn CmexBotSystemHardware::on_activate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
  // BEGIN: This part here is for exemplary purposes - Please do not copy to your production code
...
hardware_interface::CallbackReturn CmexBotSystemHardware::on_deactivate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
  // BEGIN: This part here is for exemplary purposes - Please do not copy to your production code
...
hardware_interface::return_type CmexBotSystemHardware::read(
...
hardware_interface::return_type cmexa_base ::CmexBotSystemHardware::write(
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
...
PLUGINLIB_EXPORT_CLASS(
  cmexa_base::CmexBotSystemHardware, hardware_interface::SystemInterface)