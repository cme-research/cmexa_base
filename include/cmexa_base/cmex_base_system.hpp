...
#ifndef CMEX_BASE_SYSTEM_HPP_
#define CMEX_BASE_SYSTEM_HPP_
...
namespace cmex_base
{
class CmexBotSystemHardware : public hardware_interface::SystemInterface
{
public:
  CmexBotSystemHardware();
  RCLCPP_SHARED_PTR_DEFINITIONS(CmexBotSystemHardware)
