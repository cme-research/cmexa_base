...
#ifndef CMEXA_BASE__DIFFBOT_SYSTEM_HPP_
#define CMEXA_BASE__DIFFBOT_SYSTEM_HPP_
...
{
class CmexaDiffBotSystemHardware : public hardware_interface::SystemInterface
{
public:
  CmexaDiffBotSystemHardware();
  RCLCPP_SHARED_PTR_DEFINITIONS(CmexaDiffBotSystemHardware)
...
#endif // CMEXA_BASE__DIFFBOT_SYSTEM_HPP_
